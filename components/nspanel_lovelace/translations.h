...
const std::map<const char*, const char *, compare_char_str> TRANSLATION_MAP {
...
inline const char *get_translation(const char *key) {
...
inline const char *get_translation(const std::string &key) {
